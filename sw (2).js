const CACHE = "prioridad-produccion-perfiles-v11";
const ASSETS = ["./","./index.html","./styles.css","./app-registrar-fix.js?v=11","./config.js?v=10","./manifest.webmanifest","./icons/icon-192.png","./icons/icon-512.png"];
try {
